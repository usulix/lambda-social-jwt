...
function getAccessToken(options: AuthOptions){
...
function validateAccessToken(options: AuthOptions, token){
    return new Promise((resolve, reject)=>{
        console.log(options);
        console.log(token);
...
export function facebookProvider(options: AuthOptions): Promise<*> {
